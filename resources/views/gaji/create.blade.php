...
<div class="form-container">
    <div class="card">
        <div class="card-header bg-white py-3">
            <h5 class="m-0 font-weight-bold">Input Gaji Karyawan</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('gaji.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control @error('gaji_pokok') is-invalid @enderror"
                               id="gaji_pokok_display" name="gaji_pokok_display" value="{{ old('gaji_pokok_display') }}"
                               readonly>
                    </div>
                    <input type="hidden" id="gaji_pokok" name="gaji_pokok" value="{{ old('gaji_pokok') }}">
                    @error('gaji_pokok')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control @error('tunjangan') is-invalid @enderror"
                               id="tunjangan_display" name="tunjangan_display" value="{{ old('tunjangan_display') }}"
                               readonly>
                    </div>
                    <input type="hidden" id="tunjangan" name="tunjangan" value="{{ old('tunjangan') }}">
                    @error('tunjangan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('keterangan') is-invalid @enderror"
                        ...
                        <option value="Success" {{ old('keterangan') == 'Success' ? 'selected' : '' }}>Success</option>
                        <option value="Delayed" {{ old('keterangan') == 'Delayed' ? 'selected' : '' }}>Delayed</option>
                    </select>
                    @error('keterangan')
                        <div class="invalid-feedback">
                            {{ $message }}
